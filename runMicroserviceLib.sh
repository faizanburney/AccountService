...
echo "################################################################################################"
echo  Running microservice ....$argServices....located at.... ${microservicesFolders[$argServices]}
echo "################################################################################################"
currentDir=$(pwd)
echo docker-compose -f $dockerComposeFileName up -d ${microservicesDockerNames[$argServices]} 
docker-compose -f $dockerComposeFileName up -d ${microservicesDockerNames[$argServices]} 
done
